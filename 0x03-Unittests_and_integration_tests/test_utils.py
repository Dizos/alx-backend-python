...
class TestGetJson(unittest.TestCase):
    ...
    def test_get_json(self, test_url: str, test_payload: Dict) -> None:
        """
        Tests that get_json returns the expected payload and calls requests.get correctly.
...
class TestMemoize(unittest.TestCase):
    ...
    def test_memoize(self) -> None:
        """
        Tests that the memoize decorator caches the property result and calls the underlying method once.
        """
        class TestClass:
            def a_method(self):
                return 42
